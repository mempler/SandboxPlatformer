 ...
 */
void ftbgfx::computegradient(double *img, int w, int h, double *gx, double *gy) {
    int i, j, k, p, q;
...
double ftbgfx::distaa3(double *img, double *gximg, double *gyimg, int w, int c, int xc, int yc, int xi, int yi) {
...
void ftbgfx::edtaa3(double *img, double *gx, double *gy, int w, int h, short *distx, short *disty, double *dist) {
    int x, y, i, c;
