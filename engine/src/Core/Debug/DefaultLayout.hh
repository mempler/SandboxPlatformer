...
inline void DefaultImGuiLayout( Engine *pEngine, ImGuiID dock_main_id )
{
    ...
    ImGui::DockBuilderAddNode(
        dock_main_id, ImGuiDockNodeFlags_DockSpace );  // Add empty node
    ImGui::DockBuilderSetNodeSize(
        dock_main_id, ImVec2( gameWindow.Width(), gameWindow.Height() ) );

    ImGuiID dock_id_left = ImGui::DockBuilderSplitNode(
        dock_main_id, ImGuiDir_Left, 0.3f, NULL, &dock_main_id );
