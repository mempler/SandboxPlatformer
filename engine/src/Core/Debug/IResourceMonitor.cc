...
void IResourceMonitor::Draw()
{
    ...
    // Currently we only support TextureManager as that one uses the newer
    // IResource class
    ...
    if ( ImGui::CollapsingHeader( "TextureManager" ) )
    {
                 ...
                 ImGuiTableFlags_Resizable | ImGuiTableFlags_Borders ) )
        {
            ...
            for ( auto &resource : m_pEngine->GetTextureManager() )
            {
                ...
                // NOTE: this is very expensive, lots of CPU time wasted. but it
                // should be fine.
                ...
                ImGui::TextColored(
                    ...
                    Memory::SizeInText( (double) resource.second.GetDataSize() )
                        .c_str() );  // TODO: Implement
            }
