                                     ...
                                     Identifier const &rIdentRight )
{
    ...
    {
        descLeft = AudioLoader::LoadAudio(
            loaderTypeLeft, FileSystem::ReadBinaryFile( rIdentLeft.Path() ) );
    }

    if ( rIdentRight.Protocol() == "file" )
    {
        descRight = AudioLoader::LoadAudio(
            loaderTypeRight, FileSystem::ReadBinaryFile( rIdentRight.Path() ) );
    }
