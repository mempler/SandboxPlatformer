...
Audio::Audio( AudioChannel *pChannel, Identifier const &rIdent,
              uint32_t hSrcLeft, uint32_t hSrcRight, uint32_t hBufferLeft,
...
void Audio::SetPosition( glm::vec3 v3Position )
{
    ...
    {  // YZ
        alSource3f( m_hSourceLeft, AL_POSITION, -1.0f, v3Position.y,
                    v3Position.z );
        alSource3f( m_hSourceRight, AL_POSITION, 1.0f, v3Position.y,
                    v3Position.z );
    }
}
