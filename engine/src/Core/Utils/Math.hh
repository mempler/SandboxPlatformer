...
namespace Math
{
    inline glm::mat4 CalcTransform(
        const glm::vec3 &v3Position, const glm::vec2 &v2Size,
        float fRotation = 0.f, const glm::vec3 &v3RotationAxis = { 1, 0, 0 } )
    {
